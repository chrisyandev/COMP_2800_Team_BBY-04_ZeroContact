...
MongoClient.connect(connectionString, {
    ...
    app.get("/game", (req, res) => res.render("main.ejs"));
    app.get("/minigame", (req, res) => res.render("minigame.ejs"));
    app.get("/signup", (req, res) => res.render("signup.ejs"));
    app.get("/login", (req, res) => res.render("login.ejs"));
    app.get("/delete", (req, res) => res.render("home.ejs"));
    app.get("/error", (req, res) => res.render("error.ejs"));
    app.get("/privacy-policy", (req, res) => res.render("privacy.ejs"));
    app.get("/attributions", (req, res) => res.render("attributions.ejs"));
    app.get("/contact-us", (req, res) => res.render("contact.ejs"));
